...
//   const tabs = [
//     { id: 'active', name: 'Active', count: myListings.filter(l => l.status === 'active').length },
//     { id: 'sold', name: 'Sold/Closed', count: myListings.filter(l => l.status === 'sold').length },
//     { id: 'all', name: 'All', count: myListings.length }
//   ];
